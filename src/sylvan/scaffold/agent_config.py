...
def _build_instructions(
    ...
    lines.append("- `find_code` - find code by name, signature, or meaning")
    lines.append("- `read_symbol` - get exact source of a function/class")
    lines.append("- `whats_in_file` - see what's in a file without reading it")
    lines.append("- `find_docs` - find documentation sections")
    lines.append("- `what_breaks_if_i_change` - check impact before changing something")
    lines.append("")
